...
The second line of the file contains the number of items that will be loaded from the file for this menu. In this example, we will load 6 items from the file.
The remaining lines in the file will contain the menu items, one per line.
The first tag is either the keyword OPTION or MENU.
The second tag is the name of that item.
The third tag is only found on MENU items. It contains the name of the submenu file to load next.
